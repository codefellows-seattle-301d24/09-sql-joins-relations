...
const app = express();
const conString = 'postgres://localhost:5432/kilovolt';// TODO:DONE Don't forget to set your own conString
...
app.post('/articles', function(request, response) {
  client.query(
    'INSERT INTO authors (author, "authorUrl") VALUES ($1, $2) ON CONFLICT DO NOTHING', // TODO:DONE Write a SQL query to insert a new author, ON CONFLICT DO NOTHING
    [request.body.author, request.body.authorUrl], // TODO:DONE Add the author and "authorUrl" as data for the SQL query
    function(err) {
  ...
  function queryTwo() {
    client.query(
      `SELECT author_id FROM authors WHERE author = $1`, // TODO:DONE Write a SQL query to retrieve the author_id from the authors table for the new article
      [request.body.author], // TODO:DONE Add the author name as data for the SQL query
      function(err, result) {
        if (err) console.error(err)
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT INTO articles (author_id, title, category, "publishedOn", body) VALUES ($1, $2, $3, $4, $5) `, // TODO:DONE Write a SQL query to insert the new article using the author_id from our previous query
      [author_id, request.body.title, request.body.category, request.body.publishedOn, request.body.body], // TODO:DONE Add the data from our new article, including the author_id, as data for the SQL query.
      function(err) {
        if (err) console.error(err);
...
app.put('/articles/:id', function(request, response) {
  ...
  client.query(
    `UPDATE authors SET author=$2 "authorUrl"=$3 WHERE id = $1;`,
  ...
  .then(function() {
    ...
    // TODO:DONE Add the required values from the request as data for the SQL query to interpolate
    client.query(
      `UPDATE articles SET title=#2 category=$3 "publishedOn"=$4 body$5 WHERE author_id = $1`,
