...
app.post('/articles', function(request, response) {
  client.query(
    'INSERT INTO authors VALUES ($1, $2) ON CONFLICT DO NOTHING', // TODO:DONE Write a SQL query to insert a new author, ON CONFLICT DO NOTHING
  ...
  function queryTwo() {
    client.query(
      `SELECT author_id FROM authors WHERE author_id = $1`, // TODO:DONE Write a SQL query to retrieve the author_id from the authors table for the new article
