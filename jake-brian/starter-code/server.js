...
app.get('/articles', function(request, response) {
  ...
  client.query(`SELECT authors, articles FROM kilovolt INNER JOIN articles ON author_id `)
...
app.post('/articles', function(request, response) {
  client.query(
    'INSERT INTO author ON CONFLICT DO NOTHING;', // DONE: Write a SQL query to insert a new author, ON CONFLICT DO NOTHING
    [request.body.author], // done: Add the author and "authorUrl" as data for the SQL query
    function(err) {
  ...
  function queryTwo() {
    client.query(
      `SELECT author_id FROM author WHERE author_id=$1`, // done: Write a SQL query to retrieve the author_id from the authors table for the new article
