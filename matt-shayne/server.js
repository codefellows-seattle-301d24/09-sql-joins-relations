...
app.post('/articles', function(request, response) {
  ...
  function queryTwo() {
    client.query(
      ...
      // TODO:DONE Add the author name as data for the SQL query
  ...
  function queryThree(author_id) {
    client.query(
      ...
      VALUES ($1, $2, $3, $4, $5);`, // TODO:DONE Write a SQL query to insert the new article using the author_id from our previous query
      [
        author_id,
        request.body.title,
...
app.put('/articles/:id', function(request, response) {
  ...
  .then(function() {
    ...
    // TODO:DONE Add the required values from the request as data for the SQL query to interpolate
    client.query(
      `UPDATE articles SET author=$1, title=$2, category=$3, "publishedOn"=$4, body=$5 WHERE author_id=(SELECT author_id FROM articles WHERE article_id=$6);`,
      [
        request.body.author,
        request.body.title,
        request.body.category,
